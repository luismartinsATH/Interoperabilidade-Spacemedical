...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cmf="urn:dmr-cmf" xmlns:utils="urn:CodeUtils">
  ...
  <xsl:template match="/">
    <Hl7XmlMessage>
      <MSH>
        ...
        <MSH.4><xsl:value-of select="cmf:Message/cmf:Patient/cmf:PatientID/cmf:Organisation"/></MSH.4>
        <MSH.5>SRSA</MSH.5>
 ...
 <!--        <OBX.5>
		...
		<OBX.6>
			<OBX.6.1>
				<xsl:call-template name="ConvertPathToUrl">
					<xsl:with-param name="path"  select="/cmf:Message/cmf:Reports/cmf:Report/cmf:ReportLink"/>
				</xsl:call-template>
			</OBX.6.1>
		</OBX.6>
    <OBX.11>
    ...
    <OBX.16>
        <xsl:value-of select="/cmf:Message/cmf:Reports/cmf:Report/cmf:InterpreterStaffNumber"/>^<xsl:value-of select="/cmf:Message/cmf:Reports/cmf:Report/cmf:InterpreterFamilyName"/>^<xsl:value-of select="/cmf:Message/cmf:Reports/cmf:Report/cmf:InterpreterGivenName"/>
<!--        <xsl:value-of select="/cmf:Message/cmf:Orders/cmf:Order/cmf:OrderPlacer"/> -->
    </OBX.16>
    </OBX>
    <OBX>
