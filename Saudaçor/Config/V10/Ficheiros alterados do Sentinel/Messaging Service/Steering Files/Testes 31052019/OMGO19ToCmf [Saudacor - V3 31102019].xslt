...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:dmr-cmf" xmlns:utils="urn:CodeUtils">
  ...
  <xsl:template match="/">
    <Message>
      ...
      <Patient>
        <PatientID>
          <Organisation>DRSA</Organisation>
          <!--  <xsl:value-of select="/Hl7XmlMessage/PID/PID.3/PID.3.4"/> -->
	        <!-- 	<xsl:value-of select="/Hl7XmlMessage/MSH/MSH.3"/> --> <!-- [LMM 31052019 Alteração para receber o local de origem do pedido] -->
          <PatientNumber>
            <xsl:call-template name="FunctionSelectPatientId"/>
          </PatientNumber>
          <PatientNumber2>
            <!-- <xsl:value-of select="/Hl7XmlMessage/PID/PID.3"/>		   -->
            <xsl:value-of select="/Hl7XmlMessage/PID/PID.18/PID.18.1"/> <!-- LMM Vai buscar o account number 31052019 -->
          </PatientNumber2>
        </PatientID>
        <GivenName>
        ...
        <Address>
          ...
          <HomePhone>
            <xsl:value-of select="/Hl7XmlMessage/PID/PID.13/PID.13.12"/>		  
<!--             <xsl:value-of select="/Hl7XmlMessage/PID/PID.13"/> -->
        ...
        <Visit>
          ...
          <VisitNumber>
            <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19/PV1.19.1"/>^<xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19/PV1.19.4"/> <!-- Alterado por LM -->
<!--             <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19"/> -->
          </VisitNumber>
          <DateOpened>
			  <xsl:call-template name="FunctionHl7ToXmlDateOrNow">
				  <xsl:with-param name ="date" select="/Hl7XmlMessage/PV1/PV1.44"/>
			  </xsl:call-template>
          </DateOpened>
          <Attending>
            <StaffNumber>
          ...
          <Referring>
            <StaffNumber>
            <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.1"/>
<!--               <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.8/PV1.8.1"/> -->																	   
            ...
            <GivenName>
				<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.3"/>
<!--               <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.8/PV1.8.3"/> -->
            </GivenName>
            <FamilyName>
			    <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.2"/>
    ...
    <!--         <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.3/PV1.3.1"/> -->
				    <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.2"/> <!-- Alterado por LM -->
          </PointOfCare>
          <Ward>
           <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.17/ORC.17.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.17/ORC.17.2"/>
	  ...
	  <Test>
        ...
        <UserDefinedField2Value><xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19/PV1.19.1"/>^<xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19/PV1.19.4"/></UserDefinedField2Value>
        <UserDefinedField3Value><xsl:value-of select="/Hl7XmlMessage/PID/PID.3/PID.3.4"/>^<xsl:value-of select="/Hl7XmlMessage/PID/PID.3/PID.3.5"/></UserDefinedField3Value>
      ...
      <Orders>
        <Order>
          ...
          <PlacerNumber>
            <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.3/ORC.3.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.3/ORC.3.2"/>
           <!--  <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.2/ORC.2.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.2/ORC.2.2"/> -->
          </PlacerNumber>
		      <Procedure>
		      	<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.1"/>
          </Procedure>
          <TestType>
            <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.1"/>
          </TestType>
 <!--          <Procedure>
        ...
        of the ordering provider as this will be the form it is returned in report messages. -->
          <OrderPlacer>
             <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.2"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.3"/>				
        <!--     <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.16/OBR.16.1"/>^<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.16/OBR.16.2"/>^<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.16/OBR.16.3"/> -->
          ...
          <Notes>
            <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.13/OBR.13.1"/>
          </Notes>
        </Order>
      </Orders>
    </Message>
