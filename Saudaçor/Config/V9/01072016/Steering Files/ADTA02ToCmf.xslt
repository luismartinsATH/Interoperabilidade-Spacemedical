...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:dmr-cmf" xmlns:dmr="urn:Utils">
  <xsl:include href="CommonTemplates.xslt"/>

  <!-- Date/time when the XSLT transform was called. -->
  <xsl:param name="now"/>
  ...
  <xsl:template match="/">
    <Message>
      <Processing>
        <Action type="Update"/>
        <MessageType>ADT^A02</MessageType>
        <EventTime>
      ...
      <Patient>
        ...
        <!-- Whether the in- or out-location is updated depends on the visit type. -->
        <Visit>
          <Class>
