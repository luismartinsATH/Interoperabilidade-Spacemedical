...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cmf="urn:dmr-cmf" xmlns:utils="urn:CodeUtils">
  ...
  <xsl:template match="/">
    <Hl7XmlMessage>
      ...
      <PID>
        <PID.3>
          <xsl:call-template name="FunctionToOutputPatientID"/>
...
<!--        <PID.19><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber2"/></PID.19>--> <!-- LM -->
        <PID.18><xsl:value-of select="/cmf:Message/cmf:Orders/cmf:Order/cmf:PlacerNumber"/></PID.18>--&gt;
      </PID>
      <PV1>
        <PV1.2>
...
<!--        <OBR.3><xsl:value-of select="/cmf:Message/cmf:Orders/cmf:Order/cmf:FillerNumber"/></OBR.3>-->
        ...
        <OBR.25>
          <xsl:call-template name="FunctionCmfReportStatusToHl7">
            <xsl:with-param name="interpreter" select="/cmf:Message/cmf:Reports/cmf:Report/cmf:Interpreter/text()"/>
          </xsl:call-template>
        </OBR.25>
        <OBR.34>
           <OBR.34.1><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:HookupTechnician/cmf:StaffNumber"/></OBR.34.1>
        </OBR.34>
      </OBR>
      <OBX>
        <OBX.1>1</OBX.1>
