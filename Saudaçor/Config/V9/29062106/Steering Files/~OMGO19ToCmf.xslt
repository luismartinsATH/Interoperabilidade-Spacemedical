  ...
  <xsl:template match="/">
    <Message>
      ...
      <Patient>
        <PatientID>
          <PatientNumber>
            <xsl:call-template name="FunctionExtractPatientID">
            </xsl:call-template>
...
<!--            <xsl:value-of select="/Hl7XmlMessage/PID/PID.19"/>-->
        ...
        <Visit>
          ...
          <VisitNumber>
            <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.19/PV1.19.1"/> <!-- Alterado por LM -->
          </VisitNumber>
          <DateOpened>
            <xsl:call-template name="FunctionHl7ToXmlDateOrNow">
              <xsl:with-param name ="date" select="/Hl7XmlMessage/EVN/EVN.2"/>
          ...
          <Referring>
            <StaffNumber>
            <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.1"/>
 ...
 <!--             <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.8/PV1.8.6"/> -->
            ...
            <GivenName>
	       <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.3"/>
<!--	       <xsl:value-of select="/Hl7XmlMessage/PV1/PV1.8/PV1.8.3"/> -->
            </GivenName>
            <FamilyName>
              <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.10/ORC.10.2"/>
...
<!-- LM -->
<!-- 	  <FillerNumber>
            <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.3/OBR.3.1"/>
          </FillerNumber>
-->
