    ...
    <Message>
      ...
      <Orders>
        ...
        of the ordering provider as this will be the form it is returned in report messages. -->
          <OrderPlacer>
             <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.2"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.3"/>
