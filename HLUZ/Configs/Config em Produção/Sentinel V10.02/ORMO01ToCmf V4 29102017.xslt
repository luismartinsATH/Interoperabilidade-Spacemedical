 ...
 <!--     <Facility>
      ...
      <Orders>
        <Order>
          ...
          <PlacerNumber>
			<xsl:call-template name="FunctionEscolheORC2"/> <!-- Criação de função para determinar onde está o ORC2 LM 23102017 -->
<!--        <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.2/ORC.2.1"/>^<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.2/ORC.2.2"/> --> 
    ...
    <!--    <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.1"/>^<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.2"/> -->			
			<xsl:call-template name="FunctionSentinelTestTypeToHl7"> <!-- retira o ^ do código se existir LM 29102017 -->
			    <xsl:with-param name="procedure"> <xsl:call-template name="FunctionESCOLHESentinelTestTypeToHl7"></xsl:call-template> <!-- Chama função criada em commontemplates.xsls [LM] 29102017 -->
				</xsl:with-param>
            </xsl:call-template>	
	<!-- 	<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4"/> Alteração codgio de exame para HLUZ 18/10/2017 -->
          </Procedure>
          <TestType>
	<!--    <xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.1"/>^<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4/OBR.4.2"/> -->
...
<!--   		<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4"/> --> <!-- Alteração código de exame para HLUZ LM 18/10/2017 -->
          </TestType>
          <RequestedDateTime>
            <xsl:call-template name="FunctionHl7ToXmlDateOrNow">
