...
<!-- 		<PV1.3.1><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Location/cmf:PointOfCare"/></PV1.3.1>
 ...
 <!--          <OBR.4.1>
		...
		<OBR.34> <!-- LM Teste HLUZ para output do ID do técnico que realizou a análise -->
          <OBR.34.1><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:AnalysisTechnician/cmf:StaffNumber"/></OBR.34.1>
          <OBR.34.2><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:AnalysisTechnician/cmf:FamilyName"/></OBR.34.2>
          <OBR.34.3><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:AnalysisTechnician/cmf:GivenName"/></OBR.34.3>
          <OBR.34.6><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:AnalysisTechnician/cmf:Title"/></OBR.34.6>
        </OBR.34>
      </OBR>
      <OBX>
        <OBX.1>1</OBX.1>
