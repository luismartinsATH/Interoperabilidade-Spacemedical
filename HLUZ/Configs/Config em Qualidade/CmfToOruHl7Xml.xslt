...
<!--    <PID.14><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Address/cmf:WorkPhone"/></PID.14> -->
      ...
      <PV1>
		...
		<!-- <xsl:value-of select="/cmf:Message/cmf:Test/cmf:UserDefinedField2Value"/> --> <!-- LMM 29112017 Alteração para patient class -->
		  <xsl:choose> <!-- LMM 02032018 Alteração para patient class -->
...
<!--      <PV1.3.1><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Location/cmf:PointOfCare"/></PV1.3.1>
        ...
        <PV1.7>
          <xsl:choose>
            <xsl:when test="/cmf:Message/cmf:Patient/cmf:Visit/cmf:Attending/cmf:Verified = 'True'">
            ...
            <xsl:otherwise>
              <xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:Attending/cmf:Name"/>
            </xsl:otherwise>
          </xsl:choose>
        </PV1.7>
        <PV1.8>
          <xsl:choose>
            <xsl:when test="/cmf:Message/cmf:Patient/cmf:Visit/cmf:Referring/cmf:Verified = 'True'">
            ...
            <xsl:otherwise>
              <xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:Referring/cmf:Name"/>
            </xsl:otherwise>
          </xsl:choose>
        </PV1.8>
