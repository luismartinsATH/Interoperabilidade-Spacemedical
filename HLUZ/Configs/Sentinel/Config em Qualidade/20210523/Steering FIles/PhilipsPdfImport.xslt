...
<!--      <xsl:call-template name="ExtractMiddleInitial"/> -->
      ...
      <Test>
		...
		</StartDateTime>     <!--   <xsl:call-template name="ExtractRecordingDateTime"/> -->
      ...
      <Reports>
        <Report>
         ...
         <!--  <TestType>blood pressure</TestType> --> <!--             <xsl:call-template name="ExtractTestType"/> -->
		  <TestType>holter</TestType>
          <RecordingDateTime></RecordingDateTime>
          <ReportFormat></ReportFormat>

          <ReportType>holter</ReportType> <!-- <xsl:call-template name="ExtractTestType"/> -->
