...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:dmr-cmf" xmlns:utils="urn:CodeUtils">
  ...
  <xsl:template match="/">
    <Message>
      ...
      <Test>
        <StartDateTime><xsl:value-of select="StressTest/TestSummary/ExamDate/Value"/><xsl:value-of select="StressTest/TestSummary/ExamTime/Value"/></StartDateTime>
      ...
      <Reports>
        <Report>
          ...
          <RecordingDuration><!-- <xsl:value-of select="StressTest/TestSummary/ExerciseTime/Value"/> --></RecordingDuration>
          <RecordingDateTime><xsl:value-of select="StressTest/TestSummary/ExamDate/Value"/><xsl:value-of select="StressTest/TestSummary/ExamTime/Value"/></RecordingDateTime>
          <ReportFormat></ReportFormat>
          <ReportType>Stress</ReportType>
