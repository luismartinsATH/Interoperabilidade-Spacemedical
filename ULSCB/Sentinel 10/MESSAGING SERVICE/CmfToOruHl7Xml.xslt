...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cmf="urn:dmr-cmf" xmlns:utils="urn:CodeUtils">
  ...
  <xsl:template match="/">
    <Hl7XmlMessage>
      ...
      <PID>
        <PID.3>
          <PID.3.1><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber"/></PID.3.1>
          <PID.3.4><xsl:value-of select="cmf:Message/cmf:Patient/cmf:PatientID/cmf:Organisation"/></PID.3.4>
        </PID.3>
        <PID.5>
      ...
      <PV1>
        <PV1.2><xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Visit/cmf:Class"/></PV1.2>
        <PV1.3>
      ...
      <OBX>
        ...
        <OBX.5>
          <OBX.5.1>
            <xsl:call-template name="RenameReportFile1">
