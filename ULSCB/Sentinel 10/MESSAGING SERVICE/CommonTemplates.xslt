...
<!--   <xsl:template name="RenameReportFile" xmlns:cmf="urn:dmr-cmf">
 ...
 <!--    <xsl:template name="RenameReportFile1" xmlns:cmf="urn:dmr-cmf">
    <xsl:param name="CurrentName"/>
    <xsl:variable name="givenName" select="/cmf:Message/cmf:Patient/cmf:GivenName"/>
    <xsl:variable name="patientId" select="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber"/>
	<xsl:variable name="Processo" select="/cmf:Message/cmf:Patient/cmf:Location/cmf:Ward"/>
    <xsl:variable name="arguments" select="concat($givenName, ',',$patientId, ',',$Processo)"/>
    <xsl:value-of select="utils:RenamePdf($CurrentName, '{0}-{1}-{2}.pdf', $arguments)" />
  </xsl:template>
    -->
 ...
 <xsl:template name="RenameReportFile1" xmlns:cmf="urn:dmr-cmf">
    ...
    <xsl:variable name="givenName" select="/cmf:Message/cmf:Patient/cmf:GivenName"/>
    <xsl:variable name="patientId" select="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber"/>
	<xsl:variable name="Processo">
		<xsl:choose>
			<xsl:when test="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber2">
				<xsl:value-of select="/cmf:Message/cmf:Patient/cmf:PatientID/cmf:PatientNumber2"/>
			</xsl:when>
			<xsl:when test="/cmf:Message/cmf:Patient/cmf:Location/cmf:Bed">
				<xsl:value-of select="/cmf:Message/cmf:Patient/cmf:Location/cmf:Bed"/>
			</xsl:when>
			<xsl:when test="/cmf:Message/cmf:Patient/cmf:Location/cmf:Ward">
