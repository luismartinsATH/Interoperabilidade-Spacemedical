...
-->		  
        ...
        <Location>
          <PointOfCare>
			...
			<xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.2"/>, <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.3"/>, <xsl:value-of select="/Hl7XmlMessage/ORC/ORC.12/ORC.12.4"/>
          </PointOfCare>
          <Ward>
			...
			<TestType>
				<xsl:call-template name="FunctionHl7ToSentinelProcedure">
					<xsl:with-param name="procedure">
						...
						<xsl:value-of select="/Hl7XmlMessage/OBR/OBR.4"/>
						<!-- Get the entire thing to return with the outgoing ORU  LMS -->
					</xsl:with-param>
				</xsl:call-template>
			</TestType>
<!--			
