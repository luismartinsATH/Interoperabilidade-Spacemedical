  ...
  <xsl:template name="substring-after-last">
	...
	<xsl:template name="FunctionHl7ToSentinelProcedure">
		...
		<xsl:choose>
			...
			<xsl:when test="starts-with($procedure,'ABPMONITOR')">blood pressure^00</xsl:when>  <!--   ABP  -->
			<!--    **********  FROM LomondMessagingService codes   *****  LMS 10-26-2016
					  <SupportedType hl7Code="CAR58^Ambulatory BP" sentinelType="BP" /> -->
