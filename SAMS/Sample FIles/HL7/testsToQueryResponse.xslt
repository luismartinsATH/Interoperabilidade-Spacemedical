      ...
      <records>
        <xsl:for-each select="/SentinelTests/ExtendedTest">
          <record>
            ...
            <PatientName>
              <xsl:value-of select="Patient/FamilyName"/>,<xsl:value-of select="Patient/GivenName"/>
            </PatientName>
            <PatientSex>
            ...
            <RequestDepartment>
              <xsl:value-of select="Patient/InPatientWard"/>
           </RequestDepartment>
            <RequestDate>
              <xsl:variable name="requestedDate" select="RequestedDateTime/DateTime"/>
