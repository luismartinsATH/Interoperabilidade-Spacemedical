SELECT        Patient.PatientId, Patient.GivenName AS Nome_Paciente, Patient.FamilyName AS Apelido_Paciente, Test.TestTypeName, Test.CreatedDateTime, Test.OrderID, 
